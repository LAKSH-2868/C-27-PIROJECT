...
function setup() {
	...
	rope2 = new Rope(roof.body,bob2.body,-60);
	rope3 = new Rope(roof.body,bob3.body,-120);
	rope4 = new Rope(roof.body,bob4.body,60);
	rope5 = new Rope(roof.body,bob5.body,120);
